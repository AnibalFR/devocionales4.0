      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Miembros con devocional activo - Edición de horarios y participantes
          </p>
        </div>
        <button
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {!miembro.familia?.id && (
                          <span
                            ...
                            className="inline-flex items-center justify-center w-6 h-6 rounded-full cursor-help bg-orange-100 text-orange-600"
                          >
